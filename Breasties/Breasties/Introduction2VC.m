...
#import "Introduction2VC.h"
#import "Constant.h"

@interface Introduction2VC ()

-(void)UpdateFontInTextView;

@end

@implementation Introduction2VC
...
- (void)viewDidLoad {
    ...
    self.lblTitle.text = NSLocalizedString(@"Introduction2Title", nil);
    self.lblDescription.text = NSLocalizedString(@"Introduction2Description", nil);
