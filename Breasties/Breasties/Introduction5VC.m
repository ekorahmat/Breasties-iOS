...
#import "Introduction5VC.h"
#import "Constant.h"

@interface Introduction5VC ()

-(void)UpdateFontInTextView;

@end

@implementation Introduction5VC
...
- (void)viewDidLoad {
    ...
    self.lblTitle.text = NSLocalizedString(@"Introduction5Title", nil);
    self.lblDescription.text = NSLocalizedString(@"Introduction5Description", nil);
